...
\begin{abstract}
  ...
  the stronger tag-centric requirement: the authentication tag should itself
  behave like a digest of the full $(K, U, A, M)$ context.
...
\input{sections/05-authentication-tag-as-hash-output}
\input{sections/06-authenticated-encryption-security}
