...
it; either way the recovery of $(K, U, A)$ below uses only the
...
then on $\neg\badleaf^\star$ Final-Root Input Separation
(\Cref{prop:final-root-sep}) makes $X$ and $X'$ share $(K,U,A,C)$, hence
...
root tag is a binding compact commitment to $(K, U, A, M)$ with everywhere
...
\begin{proof}
A CMTDs-4 winner exhibits $s$ distinct inputs $(K_i,U_i,A_i,M_i)$ whose
...
single shared body $C$ forces the triples $(K_i,U_i,A_i)$ pairwise
