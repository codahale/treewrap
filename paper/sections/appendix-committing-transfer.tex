...
\begin{proof}
The D-notions reduce to CMTDs-4 by
\Cref{lem:cmtds-identity-reductions} (the identity reduction for CMTDs-4
itself), whose public-permutation bound is \Cref{cor:cmtds4-pp};
