...
\Cref{sec:loss-terms}. \Cref{tab:concrete-security} records the
dominant terms and aggregate cap bounds; the proof of
\Cref{sec:concrete-claim} supplies the individual term sizes at the
work cap.
