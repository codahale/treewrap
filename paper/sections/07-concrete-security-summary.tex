...
\]
Substituting into
\Cref{cor:ae,thm:mu-ind,thm:int-rup,thm:coll,thm:asec,cor:cmtds4,thm:epre}
...
\textsf{INT-RUP} & $\Lift_c(\Ntot)$ & $\leq 2^{-128}$ \\
