...
at the joint corner $D = \Nprim = 2^{63}$ the multi-user estimates total
$5 \cdot 2^{-131} + 2^{-192} + 2^{-193}$---five eighths of the
$2^{-128}$ budget---and the largest of the remaining bounds, the $s = 2$
...
$0$. At resource splits an adversary can occupy, the matching attacks of
the Tightness paragraph below reach the $2^{-132}$ scale, four bits
under the target; the intervening distance is consumed by the two
flat-sponge composition terms and the hybrid slack recorded above, the
overhead of the indifferentiability route. The margin also widens away
