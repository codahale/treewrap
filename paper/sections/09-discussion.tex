...
The security model requires plaintext release only after the tag verifies.
\TW{} is online and single-pass, so an implementation that streams decrypted
leaf output before checking the root tag operates in the
release-of-unverified-plaintext setting of \cite{ABLMMY14}; plaintext-awareness
and \textsf{INT-RUP} security for \TW{} are unstudied.
