...
(\Cref{cor:cmtds4}) is its flat-sponge lift (\Cref{cor:cmtds4-pp}), and
\Cref{app:committing-transfer} forwards the remaining committing notions
to the same root-collision bound. Second, the random-oracle CDY
...
of \Cref{lem:adaptive-candidate-collision} and containing each
$\flatmap(R_i)$.
