...
that can matter in the hash, committing, and discoverability games. The Root Tag
Candidate Sequence lemma (\Cref{lem:root-candidate-seq}) collects those inputs
