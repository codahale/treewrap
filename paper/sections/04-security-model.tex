...
\item[$\Ntot = N + \Nprim$:] the total converted primitive-query cost
  used by the flat sponge lift. The lift of
  \Cref{app:flat-sponge-lift} is applied at $\Ntot$ because after the
  conversion of \cite[Lemma~3]{BDPV08} and common-prefix deduplication,
  the construction-internal sponge calls counted by $N$ and the
  adversary's direct primitive-interface queries counted by $\Nprim$
  form a primitive-query sequence of cost at most $N+\Nprim$.
