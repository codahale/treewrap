...
\item[$N$:] the construction interface cost, measured as the number of
  ...
  explicit induced two-way collision adversary in that corollary, whose
  source and candidate deterministic encryptions are counted exactly as
  in the $s = 2$ collision game.
