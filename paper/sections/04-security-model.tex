...
apply a single root tag hash bound; the hash and committing theorems differ
only in which collision or preimage event is reduced to that candidate sequence.
...
\item[$N$:] the construction interface cost, measured as the number of
  ...
  verification-tag terms. In the hash and committing games there is no adversary
