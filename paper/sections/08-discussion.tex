...
(\Cref{thm:cdy-full}), and the
remaining entries are marked ``?'' because, to our knowledge, neither a
context discovery attack nor a context discoverability security proof has been
published for them. Context
...
\cite{MLGR23} break with context discovery attacks (\textsf{GCM}, \textsf{CCM},
