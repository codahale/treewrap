...
tw128 seal             681     11.15      2.29      0.92      0.48      0.47      0.48
tw128 open             719     11.52      2.29      0.91      0.48      0.48      0.47
aes128gcm seal         900     15.64      0.46      0.38      0.37      0.35      0.36
aes128gcm open         910     15.10      0.45      0.37      0.36      0.35      0.35

throughput (GB/s, 1e9 bytes/s, wall-clock) (linux/amd64)

                        1B       64B      8KiB     32KiB     64KiB      1MiB     16MiB
tw128 seal            0.00      0.21      1.00      2.50      4.78      4.90      4.80
tw128 open            0.00      0.20      1.00      2.52      4.78      4.82      4.88
aes128gcm seal        0.00      0.15      5.03      6.03      6.28      6.49      6.46
aes128gcm open        0.00      0.15      5.14      6.21      6.43      6.62      6.64

=== cmd/cpb with AVX2 ===
cycles/byte (linux/amd64)

                        1B       64B      8KiB     32KiB     64KiB      1MiB     16MiB
tw128 seal             772     12.02      2.66      1.28      1.28      1.16      1.21
tw128 open             794     12.32      2.68      1.33      1.28      1.27      1.29
aes128gcm seal         867     15.09      0.45      0.37      0.37      0.35      0.35
aes128gcm open         900     14.37      0.44      0.37      0.35      0.34      0.34

throughput (GB/s, 1e9 bytes/s, wall-clock) (linux/amd64)

                        1B       64B      8KiB     32KiB     64KiB      1MiB     16MiB
tw128 seal            0.00      0.19      0.87      1.79      1.80      1.98      1.90
tw128 open            0.00      0.19      0.86      1.73      1.80      1.81      1.78
aes128gcm seal        0.00      0.15      5.08      6.14      6.28      6.59      6.57
aes128gcm open        0.00      0.16      5.22      6.29      6.50      6.76      6.77
\end{comment}
...
cycles/byte (darwin/arm64)
                        ...
                        1B       64B      8KiB     32KiB     64KiB      1MiB     16MiB
tw128 seal             603      9.51      1.94      0.90      0.87      0.86      0.86
tw128 open             651     10.27      2.00      0.89      0.86      0.85      0.85
aes128gcm seal        1025     16.74      0.54      0.45      0.44      0.42      0.44
aes128gcm open        1033     16.89      0.52      0.43      0.42      0.41      0.41

throughput (GB/s, 1e9 bytes/s, wall-clock) (darwin/arm64)

                        1B       64B      8KiB     32KiB     64KiB      1MiB     16MiB
tw128 seal            0.01      0.47      2.31      4.98      5.14      5.21      5.21
tw128 open            0.01      0.44      2.24      5.06      5.25      5.32      5.31
aes128gcm seal        0.00      0.27      8.28      9.95     10.32     10.63     10.33
aes128gcm open        0.00      0.27      8.62     10.41     10.82     11.08     10.89
\end{comment}
...
percent across the sweep, with a worst-case divergence of $10\%$ (\TW{} on the
AVX2 path at $1$\,MiB).
...
$2.29 \to 0.92 \to 0.48$ across the $8$, $32$, and $64$\,KiB columns and is
already at its bulk rate at $64$\,KiB, holding at $0.47$--$0.48$ through
$16$\,MiB. The AVX2 path follows the same shape at lower throughput ($2.66 \to
1.28$ over the same span, thereafter between $1.16$ and $1.28$); it runs the
eight instances as two groups of four rather than in a single $8$-wide
register, leaving the AVX-512 core about $2.5\times$ faster in bulk. The
\texttt{arm64} curve flattens earliest ($1.94 \to 0.90 \to 0.87 \to 0.86 \to
0.86$ cycles per byte from $8$\,KiB to $16$\,MiB): the eight-way core itself
...
floor. In wall-clock terms \TW{} reaches $4.80$\,GB/s on the \texttt{amd64}
AVX-512 host and $5.21$\,GB/s on the M4 Pro for $16$\,MiB messages.
...
\quad \TW{} encrypt      & 681 & 11.15 & 2.29 & 0.92 & 0.48 & 0.47 & 0.48 \\
\quad \TW{} decrypt      & 719 & 11.52 & 2.29 & 0.91 & 0.48 & 0.48 & 0.47 \\
\quad AES-128-GCM seal   & 900 & 15.64 & 0.46 & 0.38 & 0.37 & 0.35 & 0.36 \\
\quad AES-128-GCM open   & 910 & 15.10 & 0.45 & 0.37 & 0.36 & 0.35 & 0.35 \\
\midrule
\multicolumn{8}{l}{\emph{Intel Xeon 8581C (Emerald Rapids), AVX2}} \\
\quad \TW{} encrypt      & 772 & 12.02 & 2.66 & 1.28 & 1.28 & 1.16 & 1.21 \\
\quad \TW{} decrypt      & 794 & 12.32 & 2.68 & 1.33 & 1.28 & 1.27 & 1.29 \\
\midrule
\multicolumn{8}{l}{\emph{Apple M4 Pro, NEON\,+\,\texttt{FEAT\_SHA3}}} \\
\quad \TW{} encrypt      & 603 & 9.51 & 1.94 & 0.90 & 0.87 & 0.86 & 0.86 \\
\quad \TW{} decrypt      & 651 & 10.27 & 2.00 & 0.89 & 0.86 & 0.85 & 0.85 \\
\quad AES-128-GCM seal   & 1025 & 16.74 & 0.54 & 0.45 & 0.44 & 0.42 & 0.44 \\
\quad AES-128-GCM open   & 1033 & 16.89 & 0.52 & 0.43 & 0.42 & 0.41 & 0.41 \\
\bottomrule
\end{tabular}
\end{table}
...
\quad \TW{} (AVX-512)  & 1.00 & 2.50 & 4.78 & 4.90 & 4.80 \\
\quad \TW{} (AVX2)     & 0.87 & 1.79 & 1.80 & 1.98 & 1.90 \\
\quad AES-128-GCM      & 5.03 & 6.03 & 6.28 & 6.49 & 6.46 \\
\midrule
\multicolumn{6}{l}{\emph{Apple M4 Pro}} \\
\quad \TW{} (NEON+SHA3) & 2.31 & 4.98 & 5.14 & 5.21 & 5.21 \\
\quad AES-128-GCM       & 8.28 & 9.95 & 10.32 & 10.63 & 10.33 \\
\bottomrule
\end{tabular}
\end{table}
...
this out: per-message latency is nearly flat across them at roughly $700$
reference cycles on \texttt{amd64} ($681$ at $1$\,B versus $11.15 \times 64
\approx 714$ at $64$\,B) and $605$ core cycles on \texttt{arm64} ($603$ versus
$9.51 \times 64 \approx 609$), i.e.\ about $350$ and $300$ cycles per
...
($1.9$--$2.7$ cycles per byte across the three paths), where the message is the
...
\texttt{arm64}, against $0.48$ and $0.86$ for \TW{}---about $1.3\times$ and
$2\times$ faster. The wall-clock throughputs show the same margins: \TW{} reaches
$4.80$ and $5.21$\,GB/s against AES-128-GCM's $6.46$ and $10.33$\,GB/s. The wider
...
and GHASH key-power precomputation dominate: at $1$\,B AES-128-GCM costs $900$
and $1025$ cycles on the two hosts against \TW{}'s $681$ and $603$. This
...
$2.29$ cycles per byte at $8$\,KiB on \texttt{amd64}), but the gap narrows
