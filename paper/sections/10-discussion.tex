...
The table does not separately track tag-committing compactness, since that
strengthening has not been systematically analyzed for the comparison
schemes.
...
enters only the T-CMTDs-4 bound of \Cref{thm:tag-cmtds4}, and there only
