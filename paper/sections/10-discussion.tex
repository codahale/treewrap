...
key-commitment in the sense of \cite{BH22}; CDY is context discoverability in
...
\midrule
\TW{}                        & \Keccak[1600,12]   & yes & $32/32/32$ & yes & no  & yes & yes \\
...
from a single root tag collision bound (\Cref{sec:cmtds3}); the same tag, being
preimage-resistant, additionally yields context discoverability, which the
