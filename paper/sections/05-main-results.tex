...
dominant term in all but the multi-user case
...
$\Lift_c$ at $\leq 2^{-131}$ and decays as $2^{-256(s-1)}$ for
$s \geq 3$; the known-key $\LeafColl_{256}(\Nprim+\Nleaf)$, which the
...
$D \leq \Ntot(\Ntot+1)/(4\Nprim)$, typical of any practical
