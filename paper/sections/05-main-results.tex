...
$f_T(\Ntot) = 1 - \prod_{i=1}^{\Ntot}(1 - i/2^c)$, and each factor of
the random-permutation probability $f_P(\Ntot)$ is the corresponding
$f_T$ factor divided by a quantity $1 - i/2^{r+c} \in (0, 1]$, hence
at least as large, so $f_P(\Ntot) \leq f_T(\Ntot)$. For
