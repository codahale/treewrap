...
\Cref{thm:tag-cmtds4-ro}. The theorem allows the $s$ openings to use
distinct ciphertext bodies sharing only the final root tag; the
...
\begin{proof}
Immediate from the public-permutation corollary \Cref{cor:cmtds4-pp},
which lifts the random-oracle root-collision bound of
\Cref{thm:cmtds4-ro}. The CMTDs-4 game is the all-bodies-equal restriction of the
...
flat-sponge transform. Where \Cref{cor:cmtds4} bounds the probability
