...
\Cref{thm:cmtds4-ro}. The CMTDs-4 game shares one ciphertext body across
all $s$ openings, so a leaf tag collision cannot merge two openings and
no $\LeafColl$ term arises; equivalently, \Cref{cor:cmtds4} is the
all-bodies-equal special case of the tag-projected bound
\Cref{thm:tag-cmtds4}, in which that term drops.
\end{proof}
