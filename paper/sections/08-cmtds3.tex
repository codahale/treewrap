...
other checked triples. Thus every newly appended candidate is first
touched at its append step. The sequence therefore satisfies the
first-touch premise of Adaptive Candidate Collision
(\Cref{lem:adaptive-candidate-collision}), and its length is at most
$\qRO(\mathcal{B}) + s$.
