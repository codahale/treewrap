...
All three guarantees of this section rest on one argument: a
chronological candidate sequence of root tag inputs, bounded by the
adaptive candidate-collision and candidate-preimage lemmas of
\Cref{app:lemmas}, which controls the probability that distinct
