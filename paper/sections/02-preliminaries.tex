...
\begin{description}
  ...
  \item[Second-preimage resistance (Sec/eSec).] The standard and
    everywhere forms of second-preimage resistance of \cite{RS04} follow from
...
\end{description}
The directly proved advantages $\AdvColl_\TW$ and $\AdvePre_\TW$ are the
respective success probabilities, instantiated for \TW{} in
\Cref{sec:games-pp}; the second-preimage guarantees are inherited from
Coll in \Cref{cor:second-preimage-rs04}. Coll is the binding property and
ePre the preimage property of the tag taken as a compact commitment to
$(K, U, A, M)$---the two properties a cryptographic hash commitment provides.
