...
$1$ if $\Dec_{K_i}(U_i, A_i, C) = M_i$ for every $i$; the $s$-way
CMTs-$\ell$ (encryption) game has the adversary output the tuples alone
and returns $1$ if all encryptions $\Enc_{K_i}(U_i, A_i, M_i)$ are
...
property of the tag taken as a compact commitment to $(K, U, A, M)$---the
