...
\Cref{sec:games-pp,sec:mu-setting}: all-in-one AE, mu-ind, CMTDs-4,
the $\HTW$ collision, second-preimage, and preimage games,
$\mathsf{CDY}^\ast[\mathsf{ts}]$, and CMTs-$\ell$ for
