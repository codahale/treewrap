...
\textsf{INT-RUP}, CMTDs-4, the $\HTW$ collision, second-preimage, and preimage
...
accept or reject, the per-user sum of construction calls in mu-ind, and the
deterministic challenger decryption or encryption checks actually performed in
the committing games.
