...
primitive calls---induced by construction queries and by deterministic
challenger computations---together with direct primitive
...
games (standard and everywhere), and CMTs-$\ell$ for $\ell \in \{1,3,4\}$.
\end{definition}
