...
\Cref{app:committing-transfer}. The machinery applies uniformly to the
games named once here.
...
games, $\mathsf{CDY}^\ast[\mathsf{ts}]$, and CMTs-$\ell$ for
$\ell \in \{1,3,4\}$. In $\mathsf{CDY}^\ast[\mathsf{ts}]$ the selector
encryption is construction-internal, counted in $N$ like a challenger
check.
\end{definition}
