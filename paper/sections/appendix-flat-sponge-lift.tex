...
mu-ind, CMTDs-4, the $\HTW$ collision, second-preimage, and preimage
games, $\mathsf{CDY}^\ast[\mathsf{ts}]$, or
CMTs-$\ell$ for $\ell \in \{1,3,4\}$ (the $\mathsf{CDY}^\ast[\mathsf{ts}]$
selector encryption is construction-internal, counted in $N$ like a
challenger check). Let
$\mathcal{A}$ be a
