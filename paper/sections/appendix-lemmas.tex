...
through the Root Tag Candidate Sequence and Root Tag Hash Bound
...
same structural lemmas, adding freshness, key-test, leaf-collision, and
verification-first root guessing accounting.
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    \node[lemma] (rh) at (11.4, -2.0) {Root Tag\\ Hash Bound};
