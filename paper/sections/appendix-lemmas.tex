...
the claim. By Leaf-Transcript Recovery (\Cref{lem:leaf-recovery}),
conditioned on no leaf tag collision, equal root aggregation inputs
identify the same leaf transcript sequence.
\end{proof}
