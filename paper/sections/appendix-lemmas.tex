...
\begin{figure}[t]
  ...
  \caption{Dependency graph of the supporting lemmas in this
    ...
    \Cref{lem:transcript-inj} into the committing proofs in
    \Cref{sec:cmtds3} and the proof of \Cref{cor:committing-combined} is
    mediated by Opening
...
\Cref{sec:main-results,sec:cmtds3} and \Cref{cor:committing-combined} are
