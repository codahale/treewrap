...
multicore scaling remains unmeasured. We do not report multicore scaling
separately: once leaf chunks are assigned to workers, the remaining scaling
limit is scheduling, memory bandwidth, and ordered transport of $32$-byte leaf
tags back to the root, rather than a mode-level cryptographic effect. We report
a sweep of seven message lengths from $1$\,B to $16$\,MiB.
